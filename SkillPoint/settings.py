"""
Django settings for SkillPoint project.
...
SECRET_KEY = 'django-insecure-+j2p6l1fkl-6&qc%%4g33eue5e@x6x$v&v!ai88v=3=+o15$v!'
...
# Force Django to log the user out the moment they close their browser tab/window
